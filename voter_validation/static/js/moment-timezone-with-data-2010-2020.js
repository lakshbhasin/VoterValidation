...
// NOTE(laksh): Defers moment tz until moment loads
function deferUntilMoment(root, factory) {
	if (root.moment) {
		factory(root.moment);
	} else {
		setTimeout(function() { deferUntilMoment(root, factory); }, 50);
	}
}
...
(function (root, factory) {
	...
	if (typeof define === 'function' && define.amd) {
		...
		deferUntilMoment(root, factory);             // Browser
	}
